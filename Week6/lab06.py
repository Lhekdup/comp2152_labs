...
if not input_invalid:
  ...
  @        ..@#% @     @&*#@(         % 
   &   (  @    (   / /   *    @  .   /  
    ...
    loot_options, belt = functions_lab6.collect_loot(loot_options, belt)
    print("    ------------------------------------------------------------------")
    print("    |", end="    ")
    ...
    # Use Loot
    belt, health_points = functions_lab6.use_loot(belt, health_points)
    ...
    if num_dream_lvls != 0:
        health_points -= 1
        crazy_level = functions_lab6.inception_dream(num_dream_lvls)
    ...
    while m_health_points > 0 and health_points > 0:
        ...
        if not (attack_roll % 2 == 0):
            ...
            m_health_points = functions_lab6.hero_attacks(combat_strength, m_health_points)
            if m_health_points == 0:
                ...
                health_points = functions_lab6.monster_attacks(m_combat_strength, health_points)
                if health_points == 0:
                    num_stars = 1
                else:
                    num_stars = 2
