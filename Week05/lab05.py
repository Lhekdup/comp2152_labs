  ...
  @        ..@#% @     @&*#@(         % 
   &   (  @    (   / /   *    @  .   /  
    ...
    while m_health_points > 0 and health_points > 0:
        ...
        if not (attack_roll % 2 == 0):
            ...
            if health_points == 0:
                ...
                m_health_points = functions_lab05.hero_attacks(m_combat_strength, health_points)
                if m_health_points == 0:
                    num_stars = 3
                else:
                    num_stars = 2
    ...
    while input_invalid and tries in range(5):
        ...
        name = hero_name.split() # Lhekdup Tenzin --- 1:Lhekdup 2:Tenzin
        if len(name) != 2:
            ...
            if not name[0].isalpha() or not name[1].isalpha():
                ...
                short_name = name[0][0:2:1] + name[1][0:1:1] #Lhekdup Two = LhT
